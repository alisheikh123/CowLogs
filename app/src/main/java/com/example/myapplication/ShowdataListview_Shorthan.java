...
public class ShowdataListview_Shorthan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showdata_listview__shorthan);
        lv = (ListView) findViewById(R.id.shorthanlist);
    ...
    private void displayData() {
        ...
        CustomAdapter ca = new CustomAdapter(ShowdataListview_Shorthan.this,Id, Name,MailId,Age);
        lv.setAdapter(ca);
