...
public class ShowdataListviewhereford extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showdata_listviewhereford);
        lv = (ListView) findViewById(R.id.herefordlist);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.profile:
                ...
                startActivity(new Intent(this, HerefordFragpage.class
                ));
            ...
            case R.id.save:
                ...
                builder.setPositiveButton("Save", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        saveResult();
                        ShowdataListviewhereford.super.onBackPressed();
                    }
                });
    ...
    private void displayData() {
        ...
        CustomAdapterhereford ca = new CustomAdapterhereford(ShowdataListviewhereford.this, Id, Name, MailId, Age);
        lv.setAdapter(ca);
