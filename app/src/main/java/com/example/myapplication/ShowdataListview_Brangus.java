...
public class ShowdataListview_Brangus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showdata_listview__brangus);
        lv = (ListView) findViewById(R.id.branguslist);
    }
    @Override
    ...
    private void displayData() {
        ...
        CustomAdapter ca = new CustomAdapter(ShowdataListview_Brangus.this,Id, Name,MailId,Age);
        lv.setAdapter(ca);
