...
public class CustomAdapterhereford extends BaseAdapter {
    ...
    public CustomAdapterhereford(Context  context, ArrayList<String> Id, ArrayList<String> Name, ArrayList<String> MailId, ArrayList<String> Age
    )
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.herefordlayout, null);
