...
public class ShowdataListviewBrahman extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showdata_listview_brahman);
        lv = (ListView) findViewById(R.id.brahmanlist);
    }
    @Override
    ...
    private void displayData() {
        ...
        CustomAdapter ca = new CustomAdapter(ShowdataListviewBrahman.this,Id, Name,MailId,Age);
        lv.setAdapter(ca);
