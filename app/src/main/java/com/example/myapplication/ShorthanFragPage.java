...
public class ShorthanFragPage extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shorthan_frag_page);
...
//set the spinners adapter to the previously created one.
        ...
        pre.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(ShorthanFragPage.this, MainFragPage.class);
    ...
    public void onBackPressed() {
        ...
        builder.setPositiveButton("Save", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                saveResult();
                ShorthanFragPage.super.onBackPressed();
            }
        });
